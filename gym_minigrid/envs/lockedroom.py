...
class LockedRoom(CustomMiniGridEnv):
    """
    ...
    def __init__(
        ...
        super().__init__(grid_size=size, max_steps=10*size, visualization=visualization)
    ...
    def step(self, action):
        obs, reward, done, info = CustomMiniGridEnv.step(self, action)
