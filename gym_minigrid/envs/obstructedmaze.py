...
class ObstructedMaze_1Dlhb(ObstructedMazeEnv):
    ...
    def __init__(self, key_in_box=True, blocked=True, seed=None, visualization=False):
...
class ObstructedMaze_1Dl(ObstructedMaze_1Dlhb):
    def __init__(self, seed=None, visualization=False):
        super().__init__(False, False, seed, visualization)

class ObstructedMaze_1Dlh(ObstructedMaze_1Dlhb):
    def __init__(self, seed=None, visualization=False):
        super().__init__(True, False, seed, visualization)
...
class ObstructedMaze_Full(ObstructedMazeEnv):
    ...
    def __init__(self, agent_room=(1, 1), key_in_box=True, blocked=True,
                 num_quarters=4, num_rooms_visited=25, seed=None, visualization=False):
...
class ObstructedMaze_2Dl(ObstructedMaze_Full):
    def __init__(self, seed=None, visualization=False):
        super().__init__((2, 1), False, False, 1, 4, seed, visualization)

class ObstructedMaze_2Dlh(ObstructedMaze_Full):
    def __init__(self, seed=None, visualization=False):
        super().__init__((2, 1), True, False, 1, 4, seed, visualization)


class ObstructedMaze_2Dlhb(ObstructedMaze_Full):
    def __init__(self, seed=None, visualization=False):
        super().__init__((2, 1), True, True, 1, 4, seed, visualization)

class ObstructedMaze_1Q(ObstructedMaze_Full):
    def __init__(self, seed=None, visualization=False):
        super().__init__((1, 1), True, True, 1, 5, seed, visualization)

class ObstructedMaze_2Q(ObstructedMaze_Full):
    def __init__(self, seed=None, visualization=False):
        super().__init__((1, 1), True, True, 2, 11, seed, visualization)
